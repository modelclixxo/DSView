    ...
    "decoder": [
        {
            ...
            "id": "sdcard_sd",
            "label": "SD card (SD mode)",
            "options": {
            },
            "show": {
                "sdcard_sd": true,
                "sdcard_sd: Commands": true,
                "sdcard_sd: Decoded bits": true,
                "sdcard_sd: Decoded fields": true,
                "sdcard_sd: Fields": true,
                "sdcard_sd: Raw bits": true
            },
            "stacked decoders": [
            ],
            "version": 2,
